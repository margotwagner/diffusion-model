...
def main():
    ...
    plotter = pm.PlotMultiRuns(
        rw_dir="../data/eme-validation/random-walk/20240116_225621/rw-run-{}.csv",  # "/Users/margotwagner/diffusion-model/data/eme-validation/random-walk/20230118_192600/rw-run-{}.csv",
        eme_dir="../data/eme-validation/markov-eme/20240116_225621/eme-run-{}.csv",  # "/Users/margotwagner/diffusion-model/data/eme-validation/markov-eme/20230405_105433_2/eme-run-{}.csv",
        n_runs=100,
        n_spatial_locs=101,
