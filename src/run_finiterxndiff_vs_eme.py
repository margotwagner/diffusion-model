...
def main():
    ...
    PARTICLES_58 = "20240226_013334"
    PARTICLES_59 = "20240226_013338"
    plotter = pm.PlotMultiRuns(
        ...
        eme_dir="../data/eme-validation/markov-eme/20240226_013338/eme-run-{}.csv",  # "/Users/margotwagner/diffusion-model/data/eme-validation/markov-eme/20230405_105433_2/eme-run-{}.csv",
        n_runs=10,
        n_spatial_locs=n_space_pts,
